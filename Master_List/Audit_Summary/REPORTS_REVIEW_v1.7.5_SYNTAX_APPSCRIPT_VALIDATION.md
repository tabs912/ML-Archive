# Master List v1.7.5 Reports Review — Syntax, Apps Script Manifest, and Owner Priority Clarification
...
The owner clarified that Master List is a third-generation active output:

```text
Raw Data -> Demo P -> Master List
```

Therefore, the critical preservation target is Raw Data. Raw Data must remain fully preserved and protected. Master List protection is useful as a conservative safety mechanism, but it is not the same business-critical data-preservation priority as Raw Data.
...
2. Master List staged replacement should be treated as a conservative derived-output safeguard, not as proof that Raw Data is at risk.
